        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="graph_flot.html">Add Customer</a></li>
                        <li><a href="graph_morris.html">View Customer</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="form_basic.html">Manage Products</a></li>
                        <li><a href="form_advanced.html">Add Products</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="search_results.html">New Order</a></li>
                        <li><a href="lockscreen.html">Manage Order</a></li> 
                    </ul>
                </li>
